...
@HiveType(
    typeId: HiveTypes.placeCategory, adapterName: HiveAdapters.placeCategory)
class PlaceCategory extends HiveObject implements ModelFactory {
  PlaceCategory({
    this.id,
    this.name,
  ...
  factory PlaceCategory.fromJson(Map<String, dynamic> json) => PlaceCategory(
        ...
        placesCategorySlug: json["places_category_slug"] == null
            ? null
            : json["places_category_slug"],
